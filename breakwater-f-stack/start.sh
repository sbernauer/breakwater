...
# Copied from https://github.com/F-Stack/f-stack/blob/dev/start.sh
...
echo
echo
echo "Use the following command to stop the processes again (assuming you are using the default binary)"
echo "sudo pkill -f breakwater-f-stack"
